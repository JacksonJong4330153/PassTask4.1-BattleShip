...
static class DeploymentController
{
	...
	public static void HandleDeploymentInput ()
	{
		...
		if (SwinGame.MouseClicked (MouseButton.LeftButton)) {
			...
			if (UtilityFunctions.IsMouseInRectangle (BACK_BUTTON_LEFT, TOP_BUTTONS_TOP, PLAY_BUTTON_WIDTH, TOP_BUTTONS_HEIGHT))
				GameController.AddNewState (GameState.ViewingMainMenu);
			
			if (selected != ShipName.None) {
				_selectedShip = selected;
				if (selected == ShipName.Tug) {
					Audio.StopSoundEffect (GameResources.GameSound ("First"));
					Audio.StopSoundEffect (GameResources.GameSound ("Second"));
					Audio.StopSoundEffect (GameResources.GameSound ("Third"));
					Audio.StopSoundEffect (GameResources.GameSound ("Forth"));
					Audio.StopSoundEffect (GameResources.GameSound ("Five"));
					Audio.PlaySoundEffect (GameResources.GameSound ("First"));
				}
				else if (selected == ShipName.Submarine) {
					Audio.StopSoundEffect (GameResources.GameSound ("First"));
					Audio.StopSoundEffect (GameResources.GameSound ("Second"));
					Audio.StopSoundEffect (GameResources.GameSound ("Third"));
					Audio.StopSoundEffect (GameResources.GameSound ("Forth"));
					Audio.StopSoundEffect (GameResources.GameSound ("Five"));
					Audio.PlaySoundEffect (GameResources.GameSound ("Second"));
				}
				else if (selected == ShipName.Destroyer) {
					Audio.StopSoundEffect (GameResources.GameSound ("First"));
					Audio.StopSoundEffect (GameResources.GameSound ("Second"));
					Audio.StopSoundEffect (GameResources.GameSound ("Third"));
					Audio.StopSoundEffect (GameResources.GameSound ("Forth"));
					Audio.StopSoundEffect (GameResources.GameSound ("Five"));
					Audio.PlaySoundEffect (GameResources.GameSound ("Third"));
				}
				else if (selected == ShipName.Battleship) {
					Audio.StopSoundEffect (GameResources.GameSound ("First"));
					Audio.StopSoundEffect (GameResources.GameSound ("Second"));
					Audio.StopSoundEffect (GameResources.GameSound ("Third"));
					Audio.StopSoundEffect (GameResources.GameSound ("Forth"));
					Audio.StopSoundEffect (GameResources.GameSound ("Five"));
					Audio.PlaySoundEffect (GameResources.GameSound ("Forth"));
				}
				else if (selected == ShipName.AircraftCarrier) {
					Audio.StopSoundEffect (GameResources.GameSound ("First"));
					Audio.StopSoundEffect (GameResources.GameSound ("Second"));
					Audio.StopSoundEffect (GameResources.GameSound ("Third"));
					Audio.StopSoundEffect (GameResources.GameSound ("Forth"));
					Audio.StopSoundEffect (GameResources.GameSound ("Five"));
					Audio.PlaySoundEffect (GameResources.GameSound ("Five"));
				}
			} else {
				DoDeployClick ();
			}
		...
		if (row >= 0 & row < GameController.HumanPlayer.PlayerGrid.Height) {
			if (col >= 0 & col < GameController.HumanPlayer.PlayerGrid.Width) {
				...
				try {
					...
					//Audio.PlaySoundEffect (GameResources.GameSound ("Place"));
				}catch (Exception ex) {
