...
public class AIHardPlayer : AIPlayer
{
	...
	protected class Target
	{
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="T:AIHardPlayer.Target"/> class.
		/// </summary>
		/// <param name="shootat">Pass in the target shot at.</param>
		/// <param name="source">Pass in the location to the source.</param>
	...
	/// <summary>
	/// The default contructor for AIHardPlayer
	/// </summary>
	/// <param name="controller">Pass the controller to AIPlayer constructor</param>
