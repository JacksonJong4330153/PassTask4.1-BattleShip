...
public static class GameResources
{
	...
	private static void LoadImages ()
	{
		...
		NewImage ("BackButton", "deploy_back_button.png");
	...
	private static void LoadSounds ()
	{
		...
		NewSound ("Click", "menuclick.wav");
		NewSound ("Place", "placeship.wav");
		NewSound ("First", "tug.wav");
		NewSound ("Second", "submarine.wav");
		NewSound ("Third", "destroyer.wav");
		NewSound ("Forth", "battleship.wav");
		NewSound ("Five", "aircraft.wav");
		NewSound ("destroyed", "atomicbomb.wav");
	}
