...
static class UtilityFunctions
{
	...
	public static void AddShipName ()
	{
		SwinGame.DrawTextLines ("TUG", Color.White, Color.Transparent, GameResources.GameFont ("Menu"), FontAlignment.AlignLeft, 30, 180, SwinGame.ScreenWidth (), SwinGame.ScreenHeight ());
		SwinGame.DrawTextLines ("SUBMARINE", Color.White, Color.Transparent, GameResources.GameFont ("Menu"), FontAlignment.AlignLeft, 30, 270, SwinGame.ScreenWidth (), SwinGame.ScreenHeight ());
		SwinGame.DrawTextLines ("DESTROYER", Color.White, Color.Transparent, GameResources.GameFont ("Menu"), FontAlignment.AlignLeft, 30, 360, SwinGame.ScreenWidth (), SwinGame.ScreenHeight ());
		SwinGame.DrawTextLines ("BATTLESHIP", Color.White, Color.Transparent, GameResources.GameFont ("Menu"), FontAlignment.AlignLeft, 30, 450, SwinGame.ScreenWidth (), SwinGame.ScreenHeight ());
		SwinGame.DrawTextLines ("AIRCRAFT CARRIER", Color.White, Color.Transparent, GameResources.GameFont ("Menu"), FontAlignment.AlignLeft, 30, 540, SwinGame.ScreenWidth (), SwinGame.ScreenHeight ());
	...
	public static void ShowHighScore ()
	{
		...
		SwinGame.DrawTextLines ("High Score: " + HighScoreController.HighestScore, Color.White, Color.Transparent, GameResources.GameFont ("Menu"), FontAlignment.AlignLeft, 670, 80, SwinGame.ScreenWidth (), SwinGame.ScreenHeight ());	}
	/// <summary>
	...
	/// <summary>
	/// Adds the splash by row and collumn.
	/// </summary>
	/// <param name="row">The row.</param>
